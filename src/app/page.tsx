  ...
  return (
    <li className="flex gap-4">
      <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
        <Image src={role.logo} alt="" className="h-7 w-7" unoptimized width={50} height={50} style={{borderRadius: 50}} />
      </div>
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[image1, image3, image4, image2, image5].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Clément, a software designer and entrepreneur based in Paris. I’m the CTO of MeilleursBiens, where we develop
            technologies that that enable real estate pros to save twice as much time and money in their business.
          </p>
